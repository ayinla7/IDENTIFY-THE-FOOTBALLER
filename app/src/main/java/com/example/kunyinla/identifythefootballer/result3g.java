...
public class result3g extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_result3g);
        ...
        int score = sharedpreferences.getInt("SCORE3",0);
        ...
        retry3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int s=sharedpreferences.getInt("SCORE3", 0)-sharedpreferences.getInt("SCORE3", 0);
                k.putInt("SCORE3", s);
                k.apply();
